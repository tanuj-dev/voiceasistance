...
TEMPLATES = {
    ...
    "no_intent": [
        "How can I help you today? I can book an appointment, answer questions, or help with cancellations.",
        "What can I do for you? I can schedule an appointment or answer any questions.",
        "I'm here to help! Would you like to book an appointment or do you have a question?",
    ],
    "ask_service": [
    ...
    "booked": [
        "Your appointment is confirmed! Booking ID {id}. We'll see you on {date} at {time} for {service}. Have a wonderful day!",
        "All done! {name}, your {service} is booked for {date} at {time}. Booking ID {id}. Thank you and goodbye!",
        "Booking confirmed! ID {id}. See you on {date} at {time} for your {service}. Have a great day!",
    ],
    "slot_taken": [
